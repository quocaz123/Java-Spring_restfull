...
import com.Quokka.Jobhunter.domain.res.auth.LoginResponse;
...
public class SecurityService {
    ...
    public String createRefreshToken(String email, com.Quokka.Jobhunter.domain.res.auth.LoginResponse loginResponse) {
        com.Quokka.Jobhunter.domain.res.auth.LoginResponse.UserInsideToken userToken = new LoginResponse.UserInsideToken();
        userToken.setId(loginResponse.getUser().getId());
        userToken.setName(loginResponse.getUser().getName());
        userToken.setEmail(loginResponse.getUser().getEmail());
        Instant now = Instant.now();
